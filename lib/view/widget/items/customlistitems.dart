  ...
  Widget build(BuildContext context) {
    return InkWell(
                ...
                children: [
                  Hero(
                    ...
                    child: CachedNetworkImage(
                      imageUrl: "${AppLink.imagestaticItems}/${itemsModel.itemsImage}",
                      height: 100,
                      fit: BoxFit.fill,
                    ),
                  ),
                  ...
                  Row(
                    children: [
                     ...
                     Text(controller.deliverytime,textAlign: TextAlign.center,)
                    ],
                  ),
                  Row(
      ...
      if (itemsModel.itemsDiscount != "0")   Positioned(
                top: 4,
                left: 4,
                child: Image.asset('assets/images/saleone.png' , width: 40,))
           ],
         ),
    ));
  }
